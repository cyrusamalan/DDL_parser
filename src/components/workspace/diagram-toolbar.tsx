...
export function DiagramToolbar({ nodes, onSearchSelect }: DiagramToolbarProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="relative min-w-[200px] rounded-lg border border-zinc-200 bg-white/95 p-2 shadow-md backdrop-blur dark:border-zinc-700 dark:bg-zinc-900/95">
